  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[76rem]">
        ...
        {/* Просвет на телефоне шире, чем на десктопе, и это не прихоть
            симметрии: с md подпись и юридический текст стоят В СТРОКУ,
            и gap-6 разводит их по горизонтали. Ниже md подвал
            выстраивается в колонку — те же 24px оказываются вертикальным
            зазором между сплошным серым абзацем и рукописной подписью,
            и подпись читается как его продолжение. */}
        <div className="mt-8 flex flex-col gap-10 border-t border-[#E2D3EC] pt-8 md:mt-10 md:flex-row md:items-end md:justify-between md:gap-6">
          ...
          {/* Подтяжка только с md. Ниже подвал стоит в колонку, подпись
              оказывается прямо под юридическим текстом — и −40px загоняли
              её прямо в строку «…в переписке до оплаты»: буквы физически
              пересекались на 16px, на всех страницах сразу. */}
          <div className="shrink-0 md:-translate-y-10 md:text-right">
