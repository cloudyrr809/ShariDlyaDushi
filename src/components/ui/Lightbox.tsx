...
/** Размеры не обязательны: из админки фотографии приходят без них, и тогда
    они дотягиваются уже в браузере после загрузки картинки.

    caption — подпись к конкретному кадру, тоже необязательная: у большинства
    снимков её не будет, а там, где студия захочет пояснить («шар-цифра
    высотой 1,2 м»), она появится под фотографией. */
