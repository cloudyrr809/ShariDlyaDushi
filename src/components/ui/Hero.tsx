      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        >
          <img
            ...
            style={{ filter: "blur(3px) brightness(0.94) contrast(1.04) saturate(0.95)" }}
          />
              ...
              <img
                ...
                style={{
                  ...
                  filter: (() => {
                    ...
                    return `brightness(${bright}) saturate(${sat}) contrast(${contrast}) drop-shadow(0 5px 9px rgba(43,27,54,${shadow}))`;
                  })(),
                }}
              />
            </div>
