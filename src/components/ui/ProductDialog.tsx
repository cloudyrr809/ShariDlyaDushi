    ...
    >
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto sm:flex-row sm:overflow-hidden">
          {/* ── ФОТОГРАФИИ ── */}
          <div className="shrink-0 bg-[#F8F4F9] p-5 sm:w-[46%] sm:overflow-y-auto sm:p-6">
          ...
          <div className="flex min-h-0 flex-1 flex-col px-5 py-5 sm:overflow-y-auto sm:px-7 sm:py-6">
