...
/** Целевая высота ряда в долях его ширины.

    0.78 подобрано под привычные раскладки: при нём три вертикальных кадра
    выгоднее положить «крупный слева + два справа стопкой», чем в строку по
    три. */
const TARGET_REL = 0.78;
...
/** Выше — башня, которая не помещается в экран. */
const MAX_H = 1.05;
