...
/* Памятка по обращению с шарами. У карточки может быть два изображения —
   ...
   accent — своя подложка вместо общей. Единственный способ выделить
   карточку, оставшийся после перехода на строгую сетку 3×2: размером и
   местом в ряду там уже не выделишь, все шесть равноправны. */
export const careCards = [
  ...
  },
  {
    ...
    title: "Прячьте от солнца",
    description:
      "Прямой солнечный свет нагревает гелий — в тени шары держатся заметно дольше.",
  },
  {
