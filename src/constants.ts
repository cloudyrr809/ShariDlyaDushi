...
const memo: Record<string, MemoImage> = {
  ...
  catballon: { src: "/assets/memo/catballon.png", fx: 0.1192, fy: 0.1436, fw: 0.7664, fh: 0.708, ar: 1.0825, k: 0.9 },
...
export const careCards = [
  {
    ...
    hero: true,
    description:
      "Узел — самое слабое место: если потянуть, шар расходится по шву. Берегите и от острых углов с мишурой.",
  },
  {
    images: [memo.catballon],
    title: "Прячьте от питомцев",
    description:
  ...
  },
  {
    ...
    images: [memo.iceballon, memo.sunballon],
    tag: "важно",
    title: "Берегите от перепадов",
    description:
      "И мороз, и жара против вас: на холоде шар сжимается, у батареи и на прямом свету может лопнуть.",
  },
  ...
  // столбце, и он перевешивал. На телефоне (две колонки) диагональ та же.
  {
    ...
    accent: true,
    description:
      "Улетевший шар возвращается мусором в поля и реки. Сдуйте его и выбросьте в урну.",
  },
  {
    images: [memo.carballon],
    title: "Возите без сквозняка",
    description:
