...
const memo: Record<string, MemoImage> = {
  ...
  catballon: { src: "/assets/memo/catballon.png", fx: 0.1213, fy: 0.1435, fw: 0.763, fh: 0.7083, ar: 1.0771, k: 0.9 },
  // Сцена «температура»: шар в центре, снежинка слева снизу,
  // солнце справа сверху. Раскладка — в поле scene у карточки.
  ballon: { src: "/assets/memo/ballon.png", fx: 0.2269, fy: 0.137, fw: 0.5472, fh: 0.7269, ar: 0.7529 },
  snow: { src: "/assets/memo/snow.png", fx: 0.1065, fy: 0.0491, fw: 0.788, fh: 0.9009, ar: 0.8746 },
  sun: { src: "/assets/memo/sun.png", fx: 0.0963, fy: 0.0917, fw: 0.825, fh: 0.8185, ar: 1.0079 },
...
export const careCards = [
  ...
  },
  {
    ...
    /* СЦЕНА, А НЕ ПАРА ЗНАЧКОВ.

       Было два шара рядом с наклоном ±7° — «ледяной» и «солнечный», — и
       правило про перепады читалось как два разных совета. Теперь один
       шар посередине, а холод и жара стоят по углам: снежинка слева
       снизу, солнце справа сверху. Оба меньше шара — он главный, они
       обстоятельства.

       left / top / w — доли коробки 72×72 в процентах; высота берётся из
       пропорций содержимого (ar), поэтому раскладка не зависит от того,
       сколько прозрачных полей вокруг рисунка в самом файле. */
    images: [memo.ballon],
    scene: [
      { img: memo.ballon, left: 20, top: 13, w: 55 },
      { img: memo.sun, left: 59, top: 0, w: 35 },
      // Снежинка идёт ПОСЛЕДНЕЙ и чуть наезжает на шар: её
      // средний цвет — rgb(226, 236, 251), почти белый, и на розовой
      // подложке #FBEFF5 она просто пропадала. Плюс собственная
      // тень (shade) — контур по альфа-каналу там, где она всё же на фоне.
      { img: memo.snow, left: 0, top: 61, w: 34, shade: true },
    ],
    tag: "важно",
