...
/* Памятка по обращению с шарами. У карточки может быть два изображения —
   ...
   ЗАГОЛОВОК — ЭТО ДЕЙСТВИЕ, а не название темы. Было «Температурный
   режим», «Солнечные лучи», «Транспортировка» — существительные, которые
   называют раздел, но не говорят, что делать. Памятку читают ровно за
   этим, поэтому теперь «Берегите от перепадов», «Прячьте от солнца»,
   «Везите в закрытом салоне»: правило понятно по одному заголовку, текст
   под ним только уточняет.
...
export const careCards = [
  {
    ...
    hero: true,
    description:
      "Держите шар за ленту, не тяните за узел и берегите от острых углов и мишуры. Узел — самое слабое место композиции: именно по нему шар расходится, если потянуть.",
  },
  {
    images: [memo.catballon],
    title: "Убирайте от питомцев",
    description:
  ...
  },
  {
    ...
    description:
      "Шары боятся и мороза, и жары: на холоде сжимаются, у батареи и на солнце могут лопнуть. В тени держатся заметно дольше.",
  },
  {
    images: [memo.carballon],
    title: "Везите в закрытом салоне",
    description:
