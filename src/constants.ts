...
export const careCards = [
  ...
  },
  {
    ...
    /* СЦЕНА: солнце сзади, шар посередине, снежинка спереди.
       ...
       подложке #FBEFF5 от неё оставалось смутное пятно. Тень силуэта
       делу не помогала, а добавляла грязи, поэтому снята.
    ...
    scene: [
      ...
      { img: memo.snow, left: 0, top: 61, w: 34 },
    ],
    tag: "важно",
