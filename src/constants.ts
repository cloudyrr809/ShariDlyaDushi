...
//
// tag — одно слово над заголовком, набирается капсом в плашке. Нужен,
// чтобы шесть карточек читались как разделы памятки, а не как шесть
// одинаковых абзацев: по нему глаз находит нужное правило, не вчитываясь
// в текст каждой карточки.
