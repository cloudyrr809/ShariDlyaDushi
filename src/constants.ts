...
export const productsData = [
  ...
  },
  {
    ...
    price: 2150,
    images: ["/assets/num_2150_1.webp", "/assets/num_2150_2.webp"],
  },
  {
    id: 104,
    categoryId: "numbers",
  ...
  },
  {
    ...
    price: 2650,
    images: ["/assets/num_2650_1.webp", "/assets/num_2650_2.webp"],
  },
  {
    id: 108,
    categoryId: "numbers",
  ...
  },
  {
    ...
    price: 900,
    images: [
      "/assets/girl_900_1.webp",
      "/assets/girl_900_2.webp",
      "/assets/girl_900_3.webp",
      "/assets/girl_900_4.webp",
      "/assets/girl_900_5.webp",
    ],
  },
  {
    id: 203,
    ...
    price: 900,
    images: ["/assets/girl_900_cat.webp"],
  },
  {
    id: 204,
    categoryId: "girls",
  ...
  },
  {
    ...
    price: 3000,
    oldPrice: 3500,
    images: ["/assets/girl_3000_1.webp"],
  },
  {
    id: 206,
    categoryId: "girls",
    ...
    price: 3000,
    images: ["/assets/girl_3000_2.webp"],
  },
  {
    id: 208,
    categoryId: "girls",
  ...
  },
  {
    ...
    price: 2350,
    images: [
      "/assets/girl_2350_1.webp",
      "/assets/girl_2350_2.webp",
      "/assets/girl_2350_3.webp",
    ],
  },
  {
    id: 211,
    ...
    price: 1850,
    images: [
      "/assets/girl_1850_1.webp",
      "/assets/girl_1850_2.webp",
      "/assets/girl_1850_3.webp",
      "/assets/girl_1850_4.webp",
      "/assets/girl_1850_5.webp",
    ],
  },
  {
    id: 212,
    ...
    price: 3000,
    images: ["/assets/girl_3000_3.webp"],
  },
  ...
  },
  {
    ...
    price: 2300,
    images: [
      "/assets/boy_2300_1.webp",
      "/assets/boy_2300_2.webp",
      "/assets/boy_2300_3.webp",
    ],
  },
  {
    id: 307,
  ...
  },
  {
    ...
    price: 2400,
    images: [
      "/assets/boy_2400_1.webp",
      "/assets/boy_2400_2.webp",
      "/assets/boy_2400_3.webp",
    ],
  },
  {
    id: 313,
  ...
  },
  {
    ...
    price: 1890,
    images: [
      "/assets/women_1890_1.webp",
      "/assets/women_1890_2.webp",
      "/assets/women_1890_3.webp",
      "/assets/women_1890_4.webp",
      "/assets/women_1890_5.webp",
    ],
  },
  {
    id: 407,
    ...
    price: 2300,
    images: [
      "/assets/women_2300_1.webp",
      "/assets/women_2300_2.webp",
      "/assets/women_2300_3.webp",
      "/assets/women_2300_4.webp",
    ],
  },
  {
    id: 408,
...
type MemoImage = {
  ...
  ar: number;
  /** поправка на ОПТИЧЕСКУЮ массу: доля от общего габарита значка.

      Габарит один на все карточки, но заполненность у картинок разная.
      Считали долю непрозрачных пикселей внутри обрезки: у кота 47.9%, у
      машины 47.0%, у облака 42.2%, у пары «лёд + солнце» 75.3 и 73.4%.
      Умножив на экранный размер, получаем площадь чернил: 2294, 1905,
      1890 и 2032 px². Кот тяжелее всех — и по чернилам, и по цвету
      (единственный насыщенно-оранжевый), поэтому только ему габарит
      поджат. Остальным поправка не нужна: разброс и так в пределах 10%. */
  k?: number;
...
/* Памятка по обращению с шарами. У карточки может быть два изображения —
   ...
   ЗАГОЛОВОК — ЭТО ДЕЙСТВИЕ, а не название темы, и он держится в ОДНУ
   строку: «Возите без сквозняка» вместо «Везите в закрытом салоне»,
   которое рвалось надвое и сдвигало текст относительно соседних карточек.

   ОПИСАНИЕ НЕ ПОВТОРЯЕТ ЗАГОЛОВОК. Было «Везите в закрытом салоне» →
   «Везите в закрытом салоне без сквозняка»: половина строки уходила на
   пересказ того, что уже прочитано. Теперь заголовок называет правило, а
   описание объясняет причину.

   tag — плашка капсом над заголовком. Стоит НЕ у всех: у большинства
   карточек она повторяла заголовок другими словами («ТЕМПЕРАТУРА» над
   «Температурный режим»), то есть занимала строку и не добавляла ничего.
   Осталась там, где ставит акцент, которого в заголовке нет.

   hero — карточка занимает левую половину сетки (две колонки на два
   ряда) и показывает иллюстрацию крупно. Такая одна.
   accent — только цвет плашки. Раньше он переключал ещё и подложку
   карточки, но трёх тонов на пять карточек оказалось много: теперь
   тонов два — белый без плашки и розовый с плашкой, любой. */
export const careCards = [
  {
    images: [memo.downballon],
    title: "Держите за ленту",
    // hero — карточка на две колонки и два ряда, левая половина сетки.
    // Единственная такая; остальные квадратные и равные между собой.
    hero: true,
    description:
      "Берегите шарик от острых углов и мишуры, а также не тяните за узел, он самое слабое место шарика.",
  },
  {
    images: [memo.catballon],
    title: "Берегите от питомцев",
    description:
      "Кошке и собаке шар кажется игрушкой. Ставьте композицию выше зоны прыжка.",
  },
  {
    // Мороз и солнце были двумя отдельными карточками, хотя правило одно:
    // шару вредят перепады температуры с любой стороны. Вместе они читаются
    // как одно правило, а не как два похожих, и сетка сходится ровно на
    // пять карточек — четыре квадратные плюс большая.
    /* СЦЕНА: солнце сзади, шар посередине, снежинка спереди — и слегка
       заходит на шар, а не просто стоит рядом.

       Порядок в массиве и есть порядок слоёв. Солнце за шаром — оно
       фон, обстоятельство; снежинка перед ним — иначе она тонула:
       её средний цвет rgb(226, 236, 251), почти белый, и на розовой
       подложке #FBEFF5 от неё оставалось смутное пятно даже с
       собственной тенью — та лишь добавляла грязи, поэтому снята.
       Вместо неё — vivid (см. CareCards.tsx): насыщенность и яркость
       выше, плюс белая обводка-стикер по силуэту, чтобы граница была
       видна на любом фоне под ней, не только на розовом.

       Шар полупрозрачный: сквозь него читается солнце, и три предмета
       перестают быть одной кашей.

       left / top / w — доли коробки 72×72 в процентах; высота берётся из
       пропорций содержимого (ar). */
    images: [memo.ballon],
    scene: [
      { img: memo.sun, left: 62, top: 2, w: 34 },
      { img: memo.ballon, left: 24, top: 15, w: 52, opacity: 0.85 },
      { img: memo.snow, left: 6, top: 46, w: 42, vivid: true },
    ],
    tag: "важно",
    title: "Защищайте от перепадов",
    description:
      "На холоде шар сжимается, а у батареи и под прямыми лучами может лопнуть.",
  },
  // ПОРЯДОК ВАЖЕН: бейджи разведены по диагонали квадрата 2×2 — «важно»
  // справа сверху, «эко» слева снизу. Раньше оба стояли в правом
  // столбце, и он перевешивал. На телефоне (две колонки) диагональ та же.
  {
    images: [memo.cloud],
    tag: "эко",
    title: "Не отпускайте в небо",
    accent: true,
    description: "Давайте беречь природу. Сдуйте шар и выбросьте в урну.",
  },
  {
    images: [memo.carballon],
    title: "Перевозите бережно",
    description:
      "Открытые окна и кондиционер бьют шары потоком воздуха. В жару не оставляйте их в салоне.",
  },
];
...
export const faq = [
  {
    ...
    a: "Латексные шары мы обрабатываем составом Hi-Float — он создаёт внутри плёнку и не даёт гелию уходить. Такие шары живут от 3 дней до двух недель. Фольгированные держатся дольше всего: от двух недель до месяца.",
  },
  {
    q: "За сколько вы собираете заказ?",
    a: "Зависит от того, как заранее вы сделаете заказ. Лучше за 2-3 дня, чтобы мы успели согласовать палитру, надписи и время доставки. Если шары нужны сегодня — всё равно напишите, часть композиций мы собираем день в день.",
  },
  {
    q: "Вы доставляете только по Ярославлю?",
    a: "Доставляем по всему городу и в ближайшие пригороды. Везём в защитном транспортировочном пакете к нужному времени, при заказе от 3 000 ₽ доставка в черте города бесплатная.",
  },
  {
    q: "Можно ли забрать заказ самому?",
    a: "Конечно. Расскажем, как аккуратно самим довезти композицию. Адрес самовывоза уточняйте при заказе.",
  },
  {
  ...
  },
  {
    ...
    a: "Всё зависит от количества шаров, размера и сложности декора. Связка от 1 000 ₽, цифра от 1 300 ₽, фотозона считается индивидуально. Опишите задачу — посчитаем бесплатно и без обязательств.",
  },
  {
    q: "Организуете ли вы выездные фотосессии?",
    a: "Да, и берём на себя всё: идею, подбор локации, декор из шаров, работу фотографа и финальную обработку кадров. Через несколько дней вы получаете готовые фотографии.",
  },
  {
  ...
  },
  {
    ...
    a: "Предоплата 50% при подтверждении заказа, остальное — при получении. Принимаем перевод и наличные.",
  },
  {
