...
export default function About() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#FDFBFD] text-[#2D2433] scroll-smooth">
      ...
      {/* ══════════════════════════════════════════════════════════════════
          1. О НАС В ДВИЖЕНИИ — карусель рилсов
          ══════════════════════════════════════════════════════════════════ */}
      ...
      <section className="relative z-10 mx-auto max-w-[79rem] overflow-x-clip px-6 pt-10 pb-10 md:pt-12 md:pb-12">
        ...
        <div className="mb-10 flex flex-col gap-6 md:mb-12 md:flex-row md:items-end md:justify-between md:gap-16">
          <div>
            ...
            <h1 className="text-[1.9rem] leading-[1.15] font-semibold tracking-[-0.01em] text-[#2D2433] md:text-[2.6rem] md:leading-[1.12]">
              О нас в движении
            </h1>
          </div>
